  ...
  return (
    <>
      <div
        ...
        className="group px-6 py-6 flex flex-row justify-between items-center border rounded-lg bg-muted hover:cursor-pointer 
      ...
      >
        ...
        <div className="flex flex-row justify-center items-start gap-4">
          <Button
            variant={"outline"}
            className="flex justify-center items-center bg-white group-hover:bg-[#f9f7ff] group-hover:border-[#9b63ff] group-hover:text-[#9b63ff] transition-colors duration-300 hover:cursor-pointer"
            size={"icon"}
          >
