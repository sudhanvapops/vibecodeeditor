...
const templates: TemplateOption[] = [
    // Sample Data
    // ! Future Do in Prisma Store in Db 
    {
        id: "react",
        name: "React",
        description:
...
const TemplateSelectingModal = ({ isOpen, onClose, onSubmit }: TemplateSelectionModalProps) => {
    ...
    const filteredTemplates = templates.filter((template) => {
        ...
        const matchesCatagory = (category === "all" || template.category === category) // Returns true or false

        return matchesCatagory && matchSearch // retutns true or false
        ...
        >
            <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                {step === "select" ? (
                    <>
                        <DialogHeader>
                            <DialogTitle className="text-2xl font-bold text-[#9b63ff] flex items-center gap-2">
                                <Plus size={24} className="text-[#9b63ff]" />
                                Select a Template
                            </DialogTitle>
                            <DialogDescription>
                                            ...
                                            <div
                                                ...
                                                className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                                                    ${selectedTemplate === template.id ?
                                                        "border-[#ac7bff] shadow-[0_0_0_1px_##9b63ff,0_8px_20px_rgba(233,63,63,0.15)]" :
                                                        "hover:border-[#9b63ff] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_2px_8px_rgba(0,0,0,0.1)]"
                                                    }
                                                ...
                                                <div className="flex gap-4">
                                                    ...
                                                    >
                                                        <Image
                                                            ...
                                                            height={40}
                                                            // ! See a proper way
                                                            className={`object-contain ${template.icon === "/expressjs-icon.svg" && "invert"}`}
                                                        />
                                                    </div>
                    ...
                    <>
                                    ...
                                    {templates
                                        ...
                                        ?.features.map((feature) => (
                                            <div key={feature} className="flex items-center gap-2">
                                                <Zap size={14} className="text-[#9b63ff]" />
                        ...
                        <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
                            ...
                            <Button
                                className="bg-[#9b63ff] hover:bg-[#854be9] text-white cursor-pointer"
