...
const buildMessage = (amount:number,fullName:string) => {
...
">
  ...
  <p style="font-size: 16px; color: #444; line-height: 1.6;">
    We're happy to let you know that we’ve successfully received your payment of 
  ...
  ">
    <p style="margin: 0; font-size: 15px; color: #333;">
      ✔ <strong>Payment Status:</strong> Successful<br>
  ...
  <p style="font-size: 15px; color: #4f46e5; margin-top: 24px;">
    Warm regards,<br>
